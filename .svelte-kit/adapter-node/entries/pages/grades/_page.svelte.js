import { c as create_ssr_component, d as compute_rest_props, g as get_current_component, v as validate_component, p as spread, q as escape_attribute_value, r as escape_object, j as createEventDispatcher, f as add_attribute, e as escape, s as setContext, k as getContext, a as subscribe, u as get_store_value, h as compute_slots, t as each } from "../../../chunks/ssr.js";
import { w as writable } from "../../../chunks/index.js";
import "moment";
import "../../../chunks/index2.js";
import { u as user, A as AppShell, H as Header, N as Navbar, T as Title } from "../../../chunks/user.js";
import { c as createStyles, v as vFunc, d as dark, f as fns, a as createEventForwarder, E as Error, u as useActions, L as Loader, B as Button } from "../../../chunks/Button.js";
import { B as Box, I as IconRenderer, F as Flex, a as Image, T as Text } from "../../../chunks/Image.js";
const sizes = {
  xs: 18,
  sm: 22,
  md: 28,
...
const ActionIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Error, "Error").$$render(
      $$result,
      {
        observable,
      ...
      {
        default: () => {
          return `${loading ? `${validate_component(Loader, "Loader").$$render(
            $$result,
            {
...
const Alert = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Box, "Box").$$render(
      ...
      {
        default: () => {
          return `<div${add_attribute("class", classes.wrapper, 0)}>${icon ? `${validate_component(IconRenderer, "IconRenderer").$$render(
            $$result,
            {
              icon,
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `  ${validate_component(AppShell, "AppShell").$$render($$result, { class: "bg-white p-8" }, {}, {
    header: () => {
      return `${validate_component(Header, "Header").$$render($$result, { class: "rounded-lg", slot: "header" }, {}, {
        default: () => {
          return `<div class="p-3 rounded-lg">${validate_component(Flex, "Flex").$$render($$result, { class: "align-middle" }, {}, {
            default: () => {
              return `${validate_component(Flex, "Flex").$$render($$result, {}, {}, {
                default: () => {
      ...
      return `${validate_component(Navbar, "Navbar").$$render(
        ...
        {},
        {
          default: () => {
            ...
            )} ${validate_component(Title, "Title").$$render($$result, { order: 3 }, {}, {
              default: () => {
    ...
    default: () => {
      return `<main class="overflow-y-scroll -my-4 -mx-3 p-4 h-screen bg-white rounded-md">${validate_component(Alert$1, "Alert").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(Text, "Text").$$render($$result, { class: "mb-4" }, {}, {
            default: () => {
        ...
        default: () => {
          return `${each(grades, (grade) => {
            return `${validate_component(ListBoxItem, "ListBoxItem").$$render(
              ...
              {
                default: () => {
                  return `${validate_component(Flex, "Flex").$$render($$result, { class: "justify-between" }, {}, {
                    default: () => {
                      return `${validate_component(Title, "Title").$$render($$result, { order: 4 }, {}, {
                        default: () => {
                          return `${escape(grade.title)}`;
                        }
                      })} ${validate_component(Flex, "Flex").$$render($$result, { class: "" }, {}, {
                        default: () => {
                          return `${validate_component(Text, "Text").$$render($$result, { class: "mt-2  mr-4" }, {}, {
                            default: () => {
                              return `${escape(grade.grade)} `;
                            }
                          })} ${grade.grade > 49 ? `${validate_component(Button, "Button").$$render(
                            $$result,
                            {
