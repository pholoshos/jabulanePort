import { c as create_ssr_component, d as compute_rest_props, g as get_current_component, p as spread, e as escape, r as escape_object, f as add_attribute, v as validate_component, m as missing_component, q as escape_attribute_value } from "./ssr.js";
import { a as createEventForwarder, b as useSvelteUIThemeContext, e as useSvelteUITheme, h as css, u as useActions, c as createStyles, E as Error, k as keyframes } from "./Button.js";
...
const Text = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Error, "Error").$$render($$result, { observable, component: "Text", code: err }, {}, {})}  ${validate_component(Box$1, "Box").$$render(
      $$result,
      Object.assign(
        {},
        { root },
