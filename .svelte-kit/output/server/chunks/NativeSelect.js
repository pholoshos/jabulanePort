import { c as create_ssr_component, v as validate_component, e as escape, d as compute_rest_props, g as get_current_component, f as add_attribute, p as spread, q as escape_attribute_value, r as escape_object, m as missing_component, h as compute_slots, t as each } from "./ssr.js";
import { B as Box, T as Text, I as IconRenderer, i as is_void } from "./Image.js";
import { c as createStyles, a as createEventForwarder, u as useActions } from "./Button.js";
...
const InputWrapper = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Box, "Box").$$render(
      ...
      {
        default: () => {
          return `${label ? `${validate_component(LabelElement$1, "LabelElement").$$render($$result, Object.assign({}, { class: classes.label }, _labelProps, { label }, { id }, { labelElement }, { required }), {}, {})}` : ``} ${description ? `${validate_component(Text, "Text").$$render($$result, Object.assign({}, descriptionProps, { color: "gray" }, { class: classes.description }), {}, {
            default: () => {
              return `${escape(description)}`;
            }
          })}` : ``} ${slots.default ? slots.default({}) : ``} ${typeof error !== "boolean" && error ? `${validate_component(Text, "Text").$$render($$result, Object.assign({}, errorProps, { size }, { class: classes.error }), {}, {
            default: () => {
              return `${escape(error)}`;
            }
          })}` : ``}`;
...
const Input = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `  ${validate_component(Box, "Box").$$render(
      ...
      {
        default: () => {
          return `${icon ? `<div${add_attribute("class", classes.icon, 0)}>${validate_component(IconRenderer, "IconRenderer").$$render($$result, { icon, iconProps, iconSize: 16 }, {}, {})}</div>` : ``} ${isHTMLElement && root === "input" ? `<input${spread(
            [
