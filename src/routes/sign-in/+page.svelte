...
<div class="flex justify-center items-center h-screen bg-gray-100">
  ...
  <div class="bg-white p-8 rounded-lg shadow-md w-96">
    <img  class='mx-auto rounded-lg' width="80" src="/splearn.jpeg" alt="splearn"/>
    ...
    <form on:submit|preventDefault={handleSubmit}>
      ...
      <p class="mt-4  text-gray-500">
        <a href="/reset-password" class="text-green-500 hover:underline"
          >Forgot password?</a
        >
      </p>
    ...
    <p class="mt-4 text-center text-gray-500">
      New to Splearn? <a href="/sign-up" class="text-green-500 hover:underline"
        >Create an account</a
      >.
    </p>
